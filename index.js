...
var spiderMan = {
	...
	"email":"spidey@lewisu.edu",
	"phoneNumber":"800-spi-dey0",
	"city":"Gotham",
	"state":"NJ",
	"zip":"07101",
	"lat":"40.73",
...
var Jimmy = {
	...
	"lastName":"Barkauskas",
	"preferredName":"Jimmy",
	"email":"jbarkauskas@lewisu.edu",
	"city":"Tinley Park",
	"state":"IL",
	"zip":"60487",
	"favoriteHobby":"Frisbee golf",
...
app.get('/self', (request, response) => {
	console.log('Calling "/self" on the Node.js server.')
	response.type('application/json')
	response.send(JSON.stringify(Jimmy, null, 4))
})
